...
class ThrowingCatchingDay1Screen extends StatelessWidget {
  const ThrowingCatchingDay1Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Introduction to Throwing and the Phases of Throwing'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Throwing is a discrete skill with a clear begin and end, combining object manipulation and explosive movements; success in many sports depends on it.',
            ),
            ...
            _InfoCard(
              title: 'The Foundation of Throwing',
              icon: Icons.auto_awesome,
              lines: const [
                'Throwing is a discrete skill crucial across sports.',
                'It combines object manipulation and explosive force generation.',
                'The movement can be analyzed in three phases to improve control and performance.',
              ],
            ),
            ...
            _MovementCard(
              ...
              description: 'Wind-up moving opposite the intended throw to build force and momentum; speed is acquired here before release.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.arrow_forward,
              title: 'Execution Phase',
              description: 'Application of force in the direction of the throw, culminating in the release of the implement.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.shield,
              title: 'Follow-Through Phase',
              description: 'Immediately after release; vital for control and safe deceleration to prevent injury.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Reflection: Choose a sport with throwing and visualize its three phases.',
                'Discussion: Why is follow-through essential for accuracy and injury prevention?',
                'Discussion: How does the preparatory phase relate to Newton’s laws in generating force?',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'throw_catch_day1';
    ...
    _questions = [
      {
        ...
        'text': 'Throwing is considered a fundamental motor skill that is classified as a:',
        'options': ['Continuous skill', 'Discrete skill', 'Serial skill', 'Open skill'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which of the following is NOT one of the three recognized phases of throwing?',
        'options': ['Preparatory phase', 'Execution phase', 'Follow-through phase', 'Deceleration phase'],
        'correctIndex': 3,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'The phase where movements go opposite the intended line of projection is the:',
        'options': ['Execution phase', 'Follow-through phase', 'Preparatory phase', 'Release phase'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Phase commonly disregarded but contributes a lot to projectile control.',
        'answer': 'Follow-through phase',
        'altAnswers': ['follow-through', 'follow through phase', 'follow through'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Phase where movement is performed in the direction of the throw.',
        'answer': 'Execution phase',
        'altAnswers': ['execution', 'execution-phase', 'executionphase'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'General category of motor skill combining object manipulation and explosive movements.',
        'answer': 'Discrete skill',
        'altAnswers': ['discrete skills', 'discrete', 'discrete motor skill'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Throwing involves object familiarization and mastery, essential for success in many sports.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'In the execution phase, the thrower acquires speed before release.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The three phases of throwing are preparatory, execution, and follow-through.',
        'answer': true,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 1 Mini Quiz: Throwing & Catching',
