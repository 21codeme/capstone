...
class ContinuousSkillsDay4Screen extends StatelessWidget {
  const ContinuousSkillsDay4Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Coordination, Rhythm, and Technique'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            _HeroCard(
              icon: Icons.sync,
              text: 'Coordination aligns timing and sequencing across cycles; rhythm stabilizes tempo; technique makes movement economical.',
            ),
            SizedBox(height: 16),
            ...
            _InfoCard(
              ...
              lines: [
                'Define coordination and rhythm in cyclic skills.',
                'Link technique cues to consistent timing and efficient force application.',
                'Apply simple drills to stabilize cadence and reduce variability.',
              ],
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              icon: Icons.av_timer,
              lines: [
                'Stable cadence and tempo reduce energy spikes across cycles.',
                'Sequencing: order and timing of sub-movements within each cycle.',
                'Consistency: low variability improves predictability and control.',
              ],
            ),
            SizedBox(height: 12),
            _MovementCard(
              ...
              description: 'Relaxed upper body, mid-foot strike, steady cadence to smooth ground contact.',
            ),
            SizedBox(height: 12),
            _MovementCard(
              icon: Icons.pool,
              title: 'Swimming Technique',
              description: 'Balanced body position, rhythmic breathing, continuous catch and pull to minimize drag.',
            ),
            SizedBox(height: 12),
            _MovementCard(
              icon: Icons.pedal_bike,
              title: 'Cycling Technique',
              description: 'Smooth pedal circle, even torque, relaxed grip; maintain target cadence with gearing.',
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Describe a cue that helps you keep tempo steady under fatigue.',
                'Which technique change most improves your consistency across cycles?',
                'How do you detect and correct timing errors during practice?',
              ],
            ),
            SizedBox(height: 24),
            _MiniQuizSection(),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'continuous_skills_day4';
    ...
    _questions = [
      {
        ...
        'text': 'Which best describes rhythm in continuous skills?',
        'options': ['Random timing across cycles', 'Stable temporal pattern across repeated cycles', 'One-time explosive timing', 'Irregular sequencing of sub-movements'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Term for strokes per minute in swimming.',
        'answer': 'Stroke rate',
        'altAnswers': ['stroke rate','strokerate','strokes per minute','sr'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Consistent cadence reduces variability and improves control.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which technique cue most supports smooth cycling cadence?',
        'options': ['Press hard only at top dead center', 'Relax grip and circle the pedals evenly', 'Hold breath to brace each revolution', 'Shift randomly to change resistance'],
        'correctIndex': 1,
        'points': 2,
      },
    ];
