...
class SerialSkillsDay4Screen extends StatelessWidget {
  const SerialSkillsDay4Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Physical Engagement and Skill Application'),
      ),
        ...
        child: Column(
          ...
          children: [
            const _HeroCard(
              ...
              text: 'Physical engagement is critical in mastering serial skills. Alertness and proper warm-up prepare motor programs and sensory systems for efficient execution.',
            ),
            ...
            const _InfoCard(
              title: 'Applying Serial Skills in Practice',
              icon: Icons.auto_awesome,
              lines: [
                'Alertness and a warmed body enable efficient catching by priming motor programs and sensory readiness.',
                'Successful catching starts from slow pitching to focus on discrete catching skills and establish correct programming.',
              ],
            ),

            const SizedBox(height: 24),
            Text(
              'Physical Engagement Principles',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            const _MovementCard(
              ...
              title: 'Alertness and Warm-up',
              description: 'Essential for efficient catching; prepares motor programs and sensory systems for execution.',
            ),
            const SizedBox(height: 12),
            const _MovementCard(
              icon: Icons.sports_baseball,
              title: 'Successful Catching Starts Slow',
              description: 'Begin with slow pitching to emphasize discrete catching skills and establish correct motor programming.',
            ),

            const SizedBox(height: 24),
            const _InfoCard(
              title: 'Serial Skills in Sports (Cases)',
              icon: Icons.sports,
              lines: [
                'Most complex athletic movements are serial in nature.',
                'Examples: baseball pitch, volleyball spike, golf swing sequences.',
              ],
            ),
            ...
            const _InfoCard(
              ...
              lines: [
                'Reflection: Why is alertness essential for efficient catching? How does lack of alertness disrupt discrete steps?',
                'Discussion: Volleyball spike transitions (approach → jump → hit → landing) and drill progressions for catching starting slow.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'serial_skills_day4';
    ...
    _questions = [
      {
        ...
        'text': 'For efficient catching, the text emphasizes the importance of:',
        'options': [
          'A strong grip and fast hands.',
          'Alertness and a properly warmed body.',
          'A large glove and slow pitching.',
          'A complex motor program.',
        ],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Successful catching always starts from:',
        'options': [
          'Fast pitching',
          'Slow pitching',
          'A stationary position',
          'A complex serial skill',
        ],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Starting with slow pitching allows the performer to focus on:',
        'options': [
          'The speed of the throw.',
          'The discrete skills of catching.',
          'The opponent\'s movements.',
          'The complexity of the serial skill.',
        ],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'The physical state, along with a properly warmed body, that is essential for efficient catching.',
        'answer': 'Alertness',
        'altAnswers': ['alert', 'alertness and warm-up', 'alertness and warm up'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The type of pitching that is recommended to begin with for successful catching.',
        'answer': 'Slow pitching',
        'altAnswers': ['slow-pitching', 'slow pitch', 'slow'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The general nature of most complex athletic movements.',
        'answer': 'Serial',
        'altAnswers': ['serial skills', 'serial movement', 'serial in nature'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'The principles of physical engagement apply only to throwing and catching, not to other serial skills.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Successful catching is primarily about the speed of the pitch.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Training with slow pitching helps establish the motor program correctly.',
        'answer': true,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 4 Mini Quiz: Serial Skills',
