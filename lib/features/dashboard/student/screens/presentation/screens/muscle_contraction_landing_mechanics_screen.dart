...
class MuscleContractionLandingMechanicsScreen extends StatelessWidget {
  const MuscleContractionLandingMechanicsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Muscle Contraction & Landing Mechanics'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Concentric, isometric, and eccentric actions shape movement; landing skill protects health.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Differences among concentric, isometric, and eccentric contractions.',
                'Role of eccentric contraction in landing.',
                'Four landing support variations.',
              ],
            ),
            ...
            const SizedBox(height: 8),
            _InfoCard(
              title: 'Contraction types',
              icon: Icons.timeline,
              lines: const [
                'Concentric: muscle shortens while producing force.',
                'Isometric: contraction without motion; neutralizes force while developing strength.',
                'Eccentric: muscle lengthens under load, regulated by gravity; critical for controlled lowering and landing.',
              ],
            ),
            ...
            _MovementCard(
              ...
              title: 'Both Feet',
              description: 'Most common; functionally safer with greater hip and knee flexion.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.back_hand,
              title: 'Four-Point Support',
              description: 'Uses both arms; less stress on lower limbs; improves stability.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.front_hand,
              title: 'Three-Point Support',
              description: 'Progression of stability and balance; advances eccentric leg control.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.accessibility_new,
              title: 'One Leg',
              description: 'Greatest risk; demands high stability and control.',
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'musculoskeletal_basis_day4';
    ...
    _questions = [
      {
        ...
        'text': 'Which contraction involves muscle lengthening under force, often regulated by gravity?',
        'options': ['Concentric', 'Isometric', 'Eccentric', 'Myokinetic'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which landing variation poses the greatest risk and demands highest stability?',
        'options': ['Both feet', 'Four-point support', 'Three-point support', 'One leg'],
        'correctIndex': 3,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Type of contraction where the muscle shortens as it works.',
        'answer': 'Concentric',
        'altAnswers': ['concentric'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Functional application of eccentric contraction highly associated with injury if incorrect.',
        'answer': 'Landing',
        'altAnswers': ['landing'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Eccentric contractions are only as effective as concentric contractions in improving health parameters.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Landing with four-point support is a progression from landing with three-point support.',
        'answer': false,
        'points': 0,
      },
    ];
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, '/movement-injuries-prevention');
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: AppColors.primaryBlue,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                            ),
                            child: const Text('Continue to Day 5', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
