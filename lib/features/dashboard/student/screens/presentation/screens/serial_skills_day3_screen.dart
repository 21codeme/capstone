...
class SerialSkillsDay3Screen extends StatelessWidget {
  const SerialSkillsDay3Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Motor Program and Automaticity'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            const _HeroCard(
              icon: Icons.memory,
              text: 'A motor program is a pre-structured set of commands enabling large skills to run as one order of control, making complex actions execute as a single coordinated storm of commands.',
            ),
            ...
            const _InfoCard(
              title: 'The Role of the Motor Program',
              icon: Icons.auto_awesome,
              lines: [
                'Pre-structured and pre-processed commands coordinate complex skills as a unified control.',
                'Transitions and sequencing are supported through programming of discrete elements.',
                'Complex skills can be executed more easily when organized by a motor program.',
              ],
            ),
            ...
            const _MovementCard(
              ...
              title: 'Chunking',
              description: 'Performing complex skills in one fluid sequence; transitions coordinate discrete skills into a single execution.',
            ),
            const SizedBox(height: 12),
            const _MovementCard(
              icon: Icons.autorenew,
              title: 'Automaticity',
              description: 'When skills become automatic, unlearning or inactivating movements becomes difficult due to programmed coordination.',
            ),
            const SizedBox(height: 12),
            const _MovementCard(
              icon: Icons.link,
              title: 'Interdependence',
              description: 'Skill elements are programmed to coordinate the whole motor experience, making them interdependent in performance.',
            ),
            ...
            const _InfoCard(
              ...
              lines: [
                'Reflection: Riding a bicycle remains hard to forget; motor programs explain difficulty in unlearning automatic skills.',
                'Discussion: Chunking reduces cognitive load for faster and more efficient execution.',
                'Discussion: Give a discrete skill you perform automatically (e.g., tying shoes, typing).',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'serial_skills_day3';
    ...
    _questions = [
      {
        ...
        'text': 'A pre-structured and pre-processed set of commands that allows performers to execute a large-sized skill is known as a:',
        'options': ['Discrete skill unit', 'Transition', 'Motor program', 'Chunking sequence'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'The process of performing complex skills in one fluid motion in sequence is called:',
        'options': ['Automaticity', 'Interdependence', 'Chunking', 'Pre-processing'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Skill performance is highly influenced by motor programs, as well as the difficulty of unlearning or inactivating movements in a skill, which is referred to as:',
        'options': ['Interdependence', 'Automaticity', 'Coordination', 'Chunking'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'The concept that makes complex skills performed easily as a storm of commands from the brain to the muscles.',
        'answer': 'Motor program',
        'altAnswers': ['motor program', 'motor-program'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The state where all skills are wired to each other by a motor program, making it hard to forget the whole skill.',
        'answer': 'Interdependence',
        'altAnswers': ['interdependent', 'inter dependency', 'inter-dependence'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The type of movement that is coordinated and interdependent in the performance of a serial skill.',
        'answer': 'Elements of a skill',
        'altAnswers': ['discrete skills', 'skill elements', 'elements'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'The only way to forget the whole skill of riding a bicycle is to unlearn all the elements in a process of cracking the motor program.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The motor program is a set of commands that are structured after the skill is performed.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Automaticity in skill performance makes it easier to consciously break down and analyze the individual steps.',
        'answer': false,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 3 Mini Quiz: Serial Skills',
