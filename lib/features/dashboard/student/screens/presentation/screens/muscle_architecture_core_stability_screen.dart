...
class MuscleArchitectureCoreStabilityScreen extends StatelessWidget {
  const MuscleArchitectureCoreStabilityScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Muscle Architecture and Core Stability'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Pennation angle and architecture shape force; a stable core anchors every movement.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Pennation and its effect on force production.',
                'Four muscle architectures and real examples.',
                'Why core strength and stability matter.',
                'Isometric contraction in core muscles.',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Pennation (angle of attachment) influences movement and force.',
                'Negative relationship: greater pennation → less force translation; parallel muscles translate force better.',
              ],
            ),
            ...
            _MovementCard(
              ...
              title: 'Parallel (Strap/Fusiform)',
              description: 'Force aligns with resistance direction; fast movers like Biceps Brachii.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.call_merge,
              title: 'Unipennate',
              description: 'Fibers diagonally from line of pull; e.g., deep hand muscles.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.call_split,
              title: 'Bipennate',
              description: 'Fibers attach to one tendon from two directions; feather-like; e.g., Hamstring.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.circle,
              title: 'Circular (Sphincter)',
              description: 'Constriction-focused; not typical skeletal movement; around mouth/eyes.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Core is the base for motor skill acquisition.',
                'Isometric contractions hold positions, isolate movement, and neutralize force for precision.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'musculoskeletal_basis_day3';
    ...
    _questions = [
      {
        ...
        'text': 'Which muscle architecture has contractile force parallel to the direction of resistance?',
        'options': ['Unipennate', 'Bipennate', 'Circular', 'Parallel'],
        'correctIndex': 3,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Core muscles primarily use which contraction to stabilize and achieve isolation?',
        'options': ['Concentric', 'Eccentric', 'Isometric', 'Sphincter'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Term for the angle of attachment of muscle fibers influencing force production.',
        'answer': 'Pennation',
        'altAnswers': ['pennation', 'pennation angle', 'angle of pennation'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Architecture similar to a feather that allows greater power despite short movement.',
        'answer': 'Bipennate',
        'altAnswers': ['bipennate'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Parallel pennated muscles translate force better relative to cross-sectional area.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Circular muscles are heavily involved in skeletal movements.',
        'answer': false,
        'points': 0,
      },
    ];
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, '/muscle-contractions-landing');
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: AppColors.primaryBlue,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                            ),
                            child: const Text('Continue to Day 4', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
