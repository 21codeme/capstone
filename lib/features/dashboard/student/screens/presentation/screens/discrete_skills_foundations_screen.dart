...
class DiscreteSkillsFoundationsScreen extends StatelessWidget {
  const DiscreteSkillsFoundationsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Foundations of Movement and Motor Skills'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Movement and brain are inseparable; memory and stimuli shape motor skills and decisions.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Why movements and the brain are inseparable in human experience.',
                'How memory from movement informs future actions and intelligence.',
                'The role of CNS, senses, and stimuli in movement and memory.',
                'Types of movement: self-differentiated vs learned.',
                'Guthrie’s definition of skill and motor skills as integrated learned actions.',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Movements and the brain are inseparable; neurons exist to produce life and movement.',
                'Movements build core memories that guide future actions and decisions.',
                'CNS is enriched by senses; stimuli feed memory processing and increase through movement.',
              ],
            ),
            ...
            _MovementCard(
              icon: Icons.person,
              title: 'Self-Differentiated Movements',
              description: 'Inherited, genetically encoded, evolved (e.g., limb movement, vocalization).',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.school,
              title: 'Learned Movements',
              description: 'Acquired and mastered from long-term experience (e.g., driving, writing).',
            ),

            const SizedBox(height: 16),
            _InfoCard(
              title: 'Defining Motor Skills',
              icon: Icons.flag_circle,
              lines: const [
                'Skill (Guthrie, 1952): accomplish a result with maximum certainty using less energy or time.',
                'Motor skills are learned skills integrated to perform complex tasks.',
              ],
            ),
            ...
            const SizedBox(height: 8),
            _InfoCard(
              title: 'Own-Pace Activity',
              icon: Icons.psychology,
              lines: const [
                'Personal Reflection: a core memory formed through physical activity and its later impact.',
                'Concept Discussion: agree/disagree that intelligence is a product of past movement events with example.',
                'Application: list three daily activities; classify each as Self-Differentiated or Learned Movement with reasoning.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'discrete_skills_day1';
    ...
    _questions = [
      {
        ...
        'text': 'According to the text, what is the primary function of neurons?',
        'options': ['To store core memories', 'To produce life and movement', 'To limit sensory input', 'To define motor skills'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'What serves as a limiting factor in the formation of our brain and determines our cognitive potential?',
        'options': ['Learned movements', 'Core memories', 'Senses and stimuli', 'Musculoskeletal structure'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Term for inherited movements genetically encoded and evolved through time (e.g., limb movement).',
        'answer': 'Self-Differentiated Movements',
        'altAnswers': ['self-differentiated movements', 'self differentiated movements', 'self-differentiated', 'self differentiated'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Short definition of skill by Guthrie (1952): accomplish a result with ______ ______ using less energy or time.',
        'answer': 'Maximum Certainty',
        'altAnswers': ['maximum certainty', 'certainty', 'maximum certainty using less energy or time'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Learned movements are acquired and mastered from short-term experience.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Motor skills are defined as the ability to accomplish a result with maximum certainty, using less energy or time.',
        'answer': true,
        'points': 0,
      },
    ];
