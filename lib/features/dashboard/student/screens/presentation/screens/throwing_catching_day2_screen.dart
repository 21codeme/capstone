...
class ThrowingCatchingDay2Screen extends StatelessWidget {
  const ThrowingCatchingDay2Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Stages of Throwing: 1 and 2'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Dr. Monica Wild’s framework shows throwing develops from basic stationary movements to coordinated steps and rotation.',
            ),
            ...
            _InfoCard(
              title: 'Initial Steps in Throwing Development',
              icon: Icons.auto_awesome,
              lines: const [
                'Stage 1: stationary performer; no trunk rotation or weight shift; movement driven by hip flexion, shoulder protraction, elbow extension.',
                'Stage 2: begins rotation and introduces a small ipsilateral or contralateral step; arm motion shifts from vertical/sagittal to transverse/horizontal, mimicking a sling.',
              ],
            ),
            ...
            _MovementCard(
              ...
              title: 'Stage 1 (First Stage)',
              description: 'Basic, newly learned skill; feet stationary, no trunk rotation, no weight shift; movement from hip flexion, shoulder protraction, elbow extension.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.looks_two,
              title: 'Stage 2 (Beginner)',
              description: 'Introduces small step and rotation; arm motion shifts to transverse/horizontal plane and mimics a sling.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Reflection: How do a slight step and rotation in Stage 2 increase force generation compared to Stage 1?',
                'Discussion: Coaching cue to help a Stage 1 thrower progress to Stage 2 and why.',
                'Discussion: Why does motion progress from sagittal to transverse plane naturally?',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'throw_catch_day2';
    ...
    _questions = [
      {
        ...
        'text': 'In Stage 1 of throwing development, the performer\'s feet:',
        'options': ['Take a large step forward', 'Are primarily stationary', 'Show a contralateral step', 'Rotate with the trunk'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which movement is characteristic of Stage 1 throwing?',
        'options': ['Trunk rotation', 'Posterior-anterior shift of weight', 'Hip flexion and elbow extension', 'Ipsilateral step'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'A performer in Stage 2 of throwing development will typically show:',
        'options': ['No rotation in the body', 'A shift from sagittal/vertical to transverse/horizontal motion', 'Stable integration of trunk flexion and rotation', 'An extensive countermovement'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Stage where performer may show a little step forward in ipsilateral or contralateral pattern.',
        'answer': 'Stage 2',
        'altAnswers': ['stage two', 'beginner', 'beginner stage'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Stage where no trunk rotation is observed.',
        'answer': 'Stage 1',
        'altAnswers': ['stage one', 'first stage', 'newly learned skill'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Researcher who studied developmental stages of throwing in children.',
        'answer': 'Dr. Monica Wild',
        'altAnswers': ['monica wild', 'dr monica wild', 'monica j wild'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'In Stage 1, a posterior-anterior shift of weight is clearly observed.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The Stage 2 performer mimics a sling in the throwing movement.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Stage 1 is the first stage or newly learned throwing skill.',
        'answer': true,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 2 Mini Quiz: Throwing & Catching',
