...
class DiscreteSkillsMechanicsScreen extends StatelessWidget {
  const DiscreteSkillsMechanicsScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Rotational & Pushing/Pulling Discrete Skills'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'All musculoskeletal movement is rotational; levers and angular mechanics govern motion. Pushing/pulling apply force, often through implements.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Rotational movement and lever classes in the body.',
                'Angular mechanics: strength/power, torque, contraction speed, segment length.',
                'Pushing/pulling as force application; implements as limb extensions.',
              ],
            ),

            const SizedBox(height: 24),
            Text(
              'Levers and Angular Mechanics',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Long bones: mostly third‑class levers; shorter counterparts: second‑class.',
              ],
            ),
            const SizedBox(height: 12),
            _InfoCard(
              title: 'Angular Mechanics Factors',
              icon: Icons.speed,
              lines: const [
                'Muscle Strength/Power (stability).',
                'Torque (vulnerability to external forces).',
                'Speed of Contraction (angular velocity).',
                'Segment Lengths (shorter segments rotate easier).',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Pushing: standing up (push against ground); walking (push to move forward).',
                'Implements: extensions of limbs receiving pushing/pulling forces (e.g., oars, racquets).',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Why third‑class levers benefit speed and range required in human movement.',
                'Pirouette analysis: optimize strength, torque, speed, segment length.',
                'Force application in swimming/rowing; implements or medium as limb extensions.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'discrete_skills_day3';
    ...
    _questions = [
      {
        ...
        'text': 'What class of lever are most segments involving long bones in the body?',
      ...
      {
        'type': 'multiple_choice',
        'text': 'What determines how vulnerable a rotation is from external forces?',
        'options': ['Speed of contraction', 'Muscle strength', 'Segment lengths', 'Torque'],
        'correctIndex': 3,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Movement highly engaged in motor skills involving the application of force (e.g., standing up, walking).',
        'answer': 'Pushing',
        'altAnswers': ['pushing', 'push'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Term for tools that act as extensions of limbs, receiving applied forces.',
        'answer': 'Implements',
        'altAnswers': ['implements', 'implement'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'All musculoskeletal movements in the body are linear.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Shorter body segments rotate easier and faster than longer segments.',
        'answer': true,
        'points': 0,
      },
    ];
