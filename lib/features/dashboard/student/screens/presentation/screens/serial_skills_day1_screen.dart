...
class SerialSkillsDay1Screen extends StatelessWidget {
  const SerialSkillsDay1Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Introduction to Serial Skills and Transitions'),
      ),
        ...
        child: Column(
          ...
          children: [
            const _HeroCard(
              ...
              text: 'Serial skills are complex motor activities composed of a sequence of discrete skill units. Transitions modify the end of one skill or the beginning of the next to create seamless flow.',
            ),
            ...
            const _InfoCard(
              title: 'Defining Serial Skills',
              icon: Icons.auto_awesome,
              lines: [
                'A serial skill is a chain of discrete skills compounded as one large activity.',
                'The end phase of the first skill becomes the beginning of the next.',
                'Transitions modify the start or end of the involved discrete skills to blend movements.',
              ],
            ),
            ...
            const _MovementCard(
              ...
              title: 'Skill 1 End Altered',
              description: 'The end phase of skill 1 is altered to fit the beginning of skill 2.',
            ),
            const SizedBox(height: 12),
            const _MovementCard(
              icon: Icons.swap_horiz,
              title: 'Skill 2 Beginning Altered',
              description: 'The beginning phase of skill 2 is altered to fit the ending phase of skill 1.',
            ),
            const SizedBox(height: 12),
            const _MovementCard(
              icon: Icons.device_hub,
              title: 'Skill 1 End Altered for Multiple Skills',
              description: 'The ending phase of skill 1 is altered to link into the beginnings of two or more possible skills.',
            ),
            ...
            const _InfoCard(
              ...
              lines: [
                'Reflection: Choose a serial skill (e.g., triple jump, gymnastics) and list the discrete skills composing it.',
                'Discussion: Why are serial skills considered the hardest regarding acquisition and transfer?',
                'Discussion: In a basketball lay-up, which blending scenario fits the gather-to-jump transition?',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'serial_skills_day1';
    ...
    _questions = [
      {
        ...
        'text': 'A serial skill is best described as:',
        'options': [
          'A single, specific movement with a clear beginning and end.',
          'A repetitive movement with no clear beginning or end.',
          'A sequence of discrete skill units compounded as one large motor activity.',
          'A skill that is difficult to learn and perform.',
        ],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'The modification of either the beginning or end of involved discrete skills in a serial skill is recognized as:',
        'options': ['Chunking', 'Transitions', 'Motor Program', 'Discrete Unit'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'In a serial skill, the end phase of the first discrete skill becomes the:',
        'options': [
          'End phase of the entire serial skill.',
          'Beginning of the next discrete skill.',
          'Motor program for the entire sequence.',
          'Cue for the next transition.',
        ],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'The type of skill that is a single, specific movement with a clear beginning and end.',
        'answer': 'Discrete skill',
        'altAnswers': ['discrete', 'discrete skills', 'discrete motor skill'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The number of discrete skills that can be linked together in a serial skill.',
        'answer': 'Two or more',
        'altAnswers': ['two or more', '2 or more', 'two or more discrete skills'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The term for the modification employed at the junction of two discrete skills.',
        'answer': 'Transitions',
        'altAnswers': ['transition', 'skill transition'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Serial skills are generally easier to acquire than discrete skills due to their repetitive nature.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The end phase of discrete skill 1 can be altered to fit the beginning phases of two or more possible, independent discrete skills.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'A serial skill is essentially a chain of continuous skills.',
        'answer': false,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 1 Mini Quiz: Serial Skills',
