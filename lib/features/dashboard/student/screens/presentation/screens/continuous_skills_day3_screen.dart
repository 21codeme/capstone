...
class ContinuousSkillsDay3Screen extends StatelessWidget {
  const ContinuousSkillsDay3Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Energetics, Endurance, and Pacing'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: const [
            _HeroCard(
              icon: Icons.bolt,
              text: 'Energy management and pacing govern sustained performance: match effort with duration using efficient technique.',
            ),
            SizedBox(height: 16),
            ...
            _InfoCard(
              ...
              lines: [
                'Relate pacing strategies to energy systems and endurance.',
                'Explain steady‑state and how technique reduces energy cost.',
                'Use practical metrics (pace, HR, RPE) to plan effort.',
              ],
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Effort distribution across duration to avoid early fatigue.',
                'Steady‑state targets stabilize respiration and energy output.',
                'Technique efficiency lowers cost per cycle (stride/stroke/pedal).',
              ],
            ),
            SizedBox(height: 12),
            _MovementCard(
              icon: Icons.show_chart,
              title: 'Practical Metrics',
              description: 'Use pace, heart rate, and perceived exertion to tune effort.',
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Describe a pacing mistake and its effect on form and fatigue.',
                'Explain how technique changes at different intensities.',
                'Propose a pacing plan for a 20‑minute continuous effort.',
              ],
            ),
            SizedBox(height: 24),
            _MiniQuizSection(),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'continuous_skills_day3';
    ...
    _questions = [
      {
        ...
        'text': 'Steady‑state during continuous effort refers to:',
        'options': ['Explosive peak output', 'Balanced energy output and respiration', 'Random fluctuations in pace', 'Zero energy cost'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'A subjective scale used to gauge effort during endurance tasks.',
        'answer': 'RPE',
        'altAnswers': ['rpe', 'rate of perceived exertion', 'rate of perceived effort'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Efficient technique reduces energy cost per cycle.',
        'answer': true,
        'points': 0,
      },
    ];
