...
class ContinuousSkillsDay2Screen extends StatelessWidget {
  const ContinuousSkillsDay2Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Feedback and Control in Continuous Skills'),
      ),
        ...
        child: Column(
          ...
          children: const [
            _HeroCard(
              ...
              text: 'Continuous skills rely on ongoing feedback (internal/external) to regulate performance, correct error, and maintain rhythm.',
            ),
            SizedBox(height: 16),
            ...
            _InfoCard(
              ...
              lines: [
                'Differentiate knowledge of performance vs knowledge of results in continuous contexts.',
                'Understand closed‑loop control and error correction during ongoing movement.',
                'Identify practical cues to stabilize pacing and technique.',
              ],
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Knowledge of performance: movement quality (form, cadence, smoothness).',
                'Knowledge of results: outcome measures (time, distance, pace).',
                'Closed‑loop control: use of feedback to adjust and maintain target performance.',
              ],
            ),
            SizedBox(height: 12),
            _MovementCard(
              ...
              description: 'Using split times, heart rate, or RPE to regulate effort in real time.',
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              icon: Icons.psychology,
              lines: [
                'Describe a situation where feedback helped correct technique mid‑performance.',
                'Explain how external cues (metronome, coach) can stabilize cadence.',
                'Compare feedback strategies for beginners vs experienced performers.',
              ],
            ),
            SizedBox(height: 24),
            _MiniQuizSection(),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'continuous_skills_day2';
    ...
    _questions = [
      {
        ...
        'text': 'Knowledge of performance primarily provides feedback on:',
        'options': ['Outcome time/distance', 'Movement quality and mechanics', 'Number of attempts', 'Environmental conditions'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Control strategy relying on feedback to regulate ongoing movement.',
        'answer': 'Closed-loop control',
        'altAnswers': ['closed-loop control', 'closed loop control'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'A metronome can help stabilize cadence in continuous skills.',
        'answer': true,
        'points': 0,
      },
    ];
