...
class MusclePhysiologyFiberTypesScreen extends StatelessWidget {
  const MusclePhysiologyFiberTypesScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Muscle Physiology and Fiber Types'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Muscles move bones via contraction; fiber types and genes shape performance.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'How muscles create movement through concentric contraction.',
                'Differences between Fast-Twitch (Type II) and Slow-Twitch (Type I).',
                'Genetic factors influencing fiber profiles (ACTN3, R577X).',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Muscles shorten to pull tendons attached to bones (concentric action).',
                'Myokines released during exercise support immunity (e.g., IL-6, IL-15).',
              ],
            ),
            ...
            _MovementCard(
              icon: Icons.bolt,
              title: 'Fast-Twitch (Type II)',
              description: 'High force, quick fatigue; IIa (oxidative) and IIb (glycolytic).',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.directions_run,
              title: 'Slow-Twitch (Type I)',
              description: 'Slower contraction, high endurance due to abundant oxygen.',
            ),
            ...
            _MovementCard(
              icon: Icons.speed,
              title: 'ACTN3',
              description: 'Associated with sprinting—predominant in fast-twitch fibers.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.directions_walk,
              title: 'R577X',
              description: 'More common in elite endurance athletes—supports sustained effort.',
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'musculoskeletal_basis_day2';
    ...
    _questions = [
      {
        ...
        'text': 'Muscles classically create movement through which type of contraction?',
        'options': ['Isometric contraction', 'Eccentric contraction', 'Concentric contraction', 'Myokine contraction'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which muscle fiber type is known to produce greater force but fatigue faster?',
        'options': ['Type I', 'Type II', 'Type IIa', 'Type I and II'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'The type of muscle fiber that is resistant to fatigue and has an abundant amount of oxygen.',
        'answer': 'Slow-Twitch (Type I)',
        'altAnswers': ['slow-twitch (type i)', 'type i', 'slow twitch', 'slow-twitch'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'The gene predominantly present in fast-twitch fibers that enhances sprint abilities.',
        'answer': 'ACTN3',
        'altAnswers': ['actn3'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Exercise contributes to an\'s immunity through the release of myokines.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Slow-twitch fibers are also known as Type IIb fibers.',
        'answer': false,
        'points': 0,
      },
    ];
