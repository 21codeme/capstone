...
class MusculoskeletalBasisIntroScreen extends StatelessWidget {
  const MusculoskeletalBasisIntroScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Introduction to Musculoskeletal Basis'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              icon: Icons.healing,
              text:
                  'Movement literacy starts with understanding your skeleton—its functions, joints, and limits.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Modern physical activity prioritizes movement competency over sports achievement.',
                'Four key skeletal functions: shape, protection, storage, blood cell production.',
                'Three joint types and how they govern degrees of freedom.',
                'How joints define positions and movement limitations.',
              ],
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Focus shift: from sports dominance to functional movement and competency.',
                'Skeleton: gives shape, protects organs, stores fat/minerals, produces blood cells.',
                'Joints are the sites of motion; their type determines flexibility and constraints.',
              ],
            ),
            ...
            _MovementCard(
              ...
              title: 'Hinge Joint',
              description: 'Elbow-like joints allow motion in a single plane.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.sync,
              title: 'Pivot Joint',
              description: 'First and second cervical vertebrae allow rotation.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.sports_handball,
              title: 'Ball-and-Socket Joint',
              description: 'Hip joint permits movement across multiple planes.',
            ),

            const SizedBox(height: 16),
            _InfoCard(
              title: 'Movement Limit Example',
              icon: Icons.place,
              lines: const [
                'Greater Trochanter of the femur limits adduction to about 45°.',
              ],
            ),
  ...
  Widget build(BuildContext context) {
    return Row(
      ...
      children: [
        ...
        Expanded(
          child: Text(text, style: AppTextStyles.textTheme.bodyMedium?.copyWith(color: AppColors.textPrimary)),
        ),
      ],
    );
  }
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'musculoskeletal_basis_day1';
    ...
    _questions = [
      {
        ...
        'text': 'The modern focus of physical activity is primarily on:',
        'options': ['Sports participation and achievement', 'Movement competency and general functionality', 'Producing blood cells', 'Storing fat and minerals'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which of the following is NOT a primary function of bones mentioned in the text?',
        'options': ['Protection of internal organs', 'Storage of fat and minerals', 'Production of blood cells', 'Driving the displacement of joints'],
        'correctIndex': 3,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'The type of joint that allows movement in only one plane, like the elbow.',
        'answer': 'Hinge Joint',
        'altAnswers': ['hinge joint', 'hinge'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': "The process in the femur that limits the hip joint's movement to only 45 degrees of adduction.",
        'answer': 'Greater Trochanter',
        'altAnswers': ['greater trochanter', 'trochanter'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Bones are hardly associated with movement compared to muscles.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The hip joint is an example of a pivotal joint.',
        'answer': false,
        'points': 0,
      },
    ];
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            onPressed: () {
                              Navigator.pushReplacementNamed(context, '/muscle-physiology');
                            },
                            style: ElevatedButton.styleFrom(
                              backgroundColor: AppColors.primaryBlue,
                              padding: const EdgeInsets.symmetric(vertical: 12),
                            ),
                            child: const Text('Continue to Day 2', style: TextStyle(color: Colors.white)),
                          ),
                        ),
                      ],
                    ),
