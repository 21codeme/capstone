...
class MovementInjuriesPreventionScreen extends StatelessWidget {
  const MovementInjuriesPreventionScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Movement Injuries and Prevention'),
      ),
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              ...
              text: 'Poor landing mechanics elevate joint impact; core stability and literacy prevent injuries.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Common musculoskeletal injuries associated with poor landing mechanics.',
                'Biomechanical factors (joint angles, rotation) contributing to injury.',
            ...
            _InfoCard(
              ...
              lines: const [
                'Excessive side-to-side movement and rotation in landing heighten joint impact.',
                'Control depends on trained core and literacy in landing technique.',
              ],
            ),

            const SizedBox(height: 16),
            Text(
              'Common Movement Injuries',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            _MovementCard(
              icon: Icons.healing,
              title: 'Patellofemoral Pain (PFP) / Runner\'s Knee',
              description: 'Pain around kneecap; knees bent less forward, more inside (abduction).',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.rotate_left,
              title: 'Knee Overuse Injuries',
              description: 'Hips bent inward (adduction) at contact forces knee rotation; aggravated by limited ankle dorsiflexion.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.directions_run,
              title: 'Exertional Medial Tibial Pain (EMTP) / Shin Splints',
              description: 'Intensified training; excessive trunk/hip/knee rotation during landing.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.sports_martial_arts,
              title: 'Groin Injuries',
              description: 'Susceptibility with pelvic and hip up-down movements (transversal, frontal) in landing.',
            ),
            ...
            _InfoCard(
              ...
              icon: Icons.security,
              lines: const [
                'Train core stability and strength prior to performance.',
                'Control excessive movements and rotation through landing literacy.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'musculoskeletal_basis_day5';
    ...
    _questions = [
      {
        ...
        'text': 'Patellofemoral Pain (PFP) is most likely to develop when the knees are bent:',
        'options': ['More towards the front (flexion)', 'More towards the inside (abduction)', 'Less towards the inside (adduction)', 'More towards the outside (eversion)'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which injury is commonly known as "shin splints"?',
        'options': ['Patellofemoral Pain (PFP)', 'Groin Injuries', 'Exertional Medial Tibial Pain (EMTP)', 'Knee Overuse Injuries'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Biomechanical movement of the hip during ground contact that contributes to knee overuse injuries.',
        'answer': 'Adduction',
        'altAnswers': ['adduction'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Primary factor that must be trained prior to performance to control excessive movements and prevent injury.',
        'answer': 'Core Stability',
        'altAnswers': ['core stability', 'core strength', 'core stability / core strength', 'core'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Groin injuries are associated with pelvic and hip up-and-down movements during landing.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Insufficient ankle dorsiflexion can aggravate knee overuse injuries.',
        'answer': true,
        'points': 0,
      },
    ];
