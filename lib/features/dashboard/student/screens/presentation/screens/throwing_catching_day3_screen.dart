...
class ThrowingCatchingDay3Screen extends StatelessWidget {
  const ThrowingCatchingDay3Screen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Developmental Stages of Throwing - Stages 3, 4, and 5'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              icon: Icons.tune,
              text: 'The final three stages integrate the entire body, producing mature, powerful, and accurate throws.',
            ),

            const SizedBox(height: 16),
            Text(
              'Core Lesson: Progression to Mature Throwing',
            ...
            _InfoCard(
              ...
              lines: const [
                'Stages 3–5 show progressive whole‑body integration into throwing, culminating in a mature skill.',
              ],
            ),
            ...
            _MovementCard(
              icon: Icons.looks_3,
              title: 'Stage 3 (Intermediate Performer)',
              description: 'Ipsilateral arm‑leg forward; ball held high; little to no trunk rotation during the throw; rotation observable in follow‑through.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.looks_4,
              title: 'Stage 4 (Pre‑Mature Stage)',
              description: 'Observable contralateral arm‑leg movements; still little hip/trunk rotation during the throw; more integrated trunk rotation‑flexion in follow‑through.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.looks_5,
              title: 'Stage 5 (Mature Throwing Skill)',
              description: 'Extensive countermovement in the preparatory phase; stable trunk flexion‑rotation in follow‑through; ipsilateral leg moves forward post‑release.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Reflection: Why is contralateral movement more efficient for throwing?',
                'Discussion: Single characteristic that immediately signals Stage 5 vs Stage 4.',
                'Discussion: How does extensive countermovement relate to elastic energy storage?',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'throw_catch_day3';
    ...
    _questions = [
      {
        ...
        'text': 'A key characteristic of Stage 3 (Intermediate Performer) is:',
        'options': ['Contralateral arm‑leg action', 'Little to no rotation of the trunk yet', 'Extensive countermovement in the preparatory phase', 'Stable integration of trunk flexion and rotation'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'The Stage 4 (Pre‑Mature Stage) throwing skill is characterized by:',
        'options': ['Ipsilateral arm‑leg action', 'Primarily stationary feet', 'Observable contralateral arm‑leg movements', 'No rotation in the hips and trunk'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'The mature throwing skill (Stage 5) is dramatically shown by:',
        'options': ['The ball being placed above the shoulder', 'An extensive countermovement in its preparatory phase', 'The performer mimicking a sling', 'Only hip flexion and elbow extension'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Stage where the follow‑through shows a stable integration of trunk flexion and rotation.',
        'answer': 'Stage 5',
        'altAnswers': ['stage 5', 'stage five', 'mature skill', 'mature throwing skill'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Stage with an ipsilateral (same side) action of the arm and leg.',
        'answer': 'Stage 3',
        'altAnswers': ['stage 3', 'stage three', 'intermediate performer'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Stage with more integrated trunk rotation‑flexion in follow‑through but still little hip/trunk rotation during the throw.',
        'answer': 'Stage 4',
        'altAnswers': ['stage 4', 'stage four', 'pre‑mature stage', 'premature stage'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'In Stage 3, the ball is placed above the shoulder as the leg moves forward.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'The Stage 4 performer strides forward with the ipsilateral leg to establish dynamic stability.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Stage 5 includes the ipsilateral leg moving forward as part of post‑release movements.',
        'answer': true,
        'points': 0,
      },
    ];
  ...
  void _submit() async {
    ...
    try {
      ...
      await qs.logQuizAttempt(
        ...
        quizId: _quizId,
        quizTitle: 'Day 3 Mini Quiz: Throwing & Catching',
