...
class DiscreteSkillsClassificationScreen extends StatelessWidget {
  const DiscreteSkillsClassificationScreen({super.key});
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Classification of Motor Skills'),
      ),
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            _HeroCard(
              icon: Icons.category,
              text: 'Motor skills classify by musculature, environmental stability, and action specificity—discrete skills are the building blocks.',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Gross vs Fine motor skills (musculature).',
                'Open Motor System vs Closed‑Loop Motor System (environment).',
                'Discrete, Serial, Continuous skills (action begin/end).',
              ],
            ),

            const SizedBox(height: 24),
            Text(
              'Classification by Musculature',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            _MovementCard(
              ...
              description: 'Large musculature; big movements (e.g., walking, running).',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.edit,
              title: 'Fine Motor Skills',
              description: 'Smaller musculature; fine control (e.g., writing, guitar).',
            ),

            const SizedBox(height: 24),
            Text(
              'Classification by Environment (System)',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            _InfoCard(
              ...
              lines: const [
                'Open Motor System: structured before execution; no peripheral feedback during performance.',
                'Closed‑Loop Motor System: uses feedback to modify while performing.',
              ],
            ),

            const SizedBox(height: 24),
            Text(
              'Classification by Action (Beginning and End)',
              style: AppTextStyles.textTheme.titleLarge?.copyWith(
                color: AppColors.textPrimary,
                fontWeight: FontWeight.bold,
              ),
            ...
            _MovementCard(
              ...
              title: 'Discrete Skills',
              description: 'Defined beginning/end; building‑block skills.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.list_alt,
              title: 'Serial Skills',
              description: 'Sequence of discrete skills.',
            ),
            const SizedBox(height: 12),
            _MovementCard(
              icon: Icons.loop,
              title: 'Continuous Skills',
              description: 'Ongoing; unclear begin/end (e.g., running).',
            ),
            ...
            _InfoCard(
              ...
              lines: const [
                'System Comparison: catching a baseball (Open) vs balancing on a beam (Closed‑Loop). Why does one allow feedback? ',
                'Building Blocks: example of a Serial Skill and its discrete components (e.g., basketball free throw).',
                'Self‑Assessment: classify a favorite sport/activity by Musculature, Environment, and Action.',
              ],
            ),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'discrete_skills_day2';
    ...
    _questions = [
      {
        ...
        'text': 'Which classification allows modifications while the skill is being executed?',
        'options': ['Open Motor System', 'Gross Motor Skills', 'Closed-Loop Motor System', 'Discrete Skills'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which is an example of a Fine Motor Skill?',
        'options': ['Running', 'Walking', 'Writing', 'Shooting a basketball'],
        'correctIndex': 2,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Skill with defined beginning and end; building-block skills.',
        'answer': 'Discrete Skills',
        'altAnswers': ['discrete skills', 'discrete skill', 'discrete'],
        'points': 3,
      },
      {
        'type': 'identification',
        'text': 'Skill composed of a sequence of discrete skills.',
        'answer': 'Serial Skills',
        'altAnswers': ['serial skills', 'serial skill', 'serial'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Gross Motor Skills use smaller musculature and finer movement characteristics.',
        'answer': false,
        'points': 0,
      },
      {
        'type': 'true_false',
        'text': 'Serial and Continuous skills are both composed of several segments of discrete skills.',
        'answer': false,
        'points': 0,
      },
    ];
