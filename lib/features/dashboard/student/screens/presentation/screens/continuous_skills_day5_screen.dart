...
class ContinuousSkillsDay5Screen extends StatelessWidget {
  const ContinuousSkillsDay5Screen({super.key});
        ...
        child: Column(
          ...
          children: const [
            _HeroCard(
              ...
              text: 'Synthesize continuous skills: apply rhythm, cadence, pacing, and technique to real tasks with simple plans.',
            ),
            SizedBox(height: 16),
            ...
            _InfoCard(
              ...
              lines: [
                'Review core concepts: rhythm, cadence, pacing, technique.',
                'Build simple practice plans using practical metrics.',
                'Reflect on fatigue management and consistency under real conditions.',
              ],
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Warm‑up with light cadence anchoring (metronome or internal cue).',
                'Main set: target steady pace with technique focus (posture, breathing).',
                'Cool‑down and reflection: note HR, pace, RPE, and consistency.',
              ],
            ),
            SizedBox(height: 12),
            _MovementCard(
              ...
              description: 'Even pacing with negative split goal; maintain relaxed form and breathing.',
            ),
            SizedBox(height: 12),
            _MovementCard(
              icon: Icons.pool,
              title: 'Swimming Set',
              description: 'Stroke rate control with technique efficiency to reduce drag and variability.',
            ),
            SizedBox(height: 12),
            _MovementCard(
              icon: Icons.pedal_bike,
              title: 'Cycling Ride',
              description: 'Steady cadence with smooth torque and cadence‑gearing adjustments.',
            ),
            SizedBox(height: 24),
            ...
            _InfoCard(
              ...
              lines: [
                'Which cue best helped you maintain rhythm under fatigue?',
                'How did your metrics (pace/HR/RPE) reflect your pacing strategy?',
                'What technique adjustment most improved consistency across cycles?',
              ],
            ),
            SizedBox(height: 24),
            _MiniQuizSection(),
...
class _MiniQuizSectionState extends State<_MiniQuizSection> {
  ...
  int _maxScore = 0;
  bool _passed = false;
  final String _quizId = 'continuous_skills_day5';
    ...
    _questions = [
      {
        ...
        'text': 'Best pacing strategy for a 5k to avoid burnout?',
        'options': ['Sprint start then fade', 'Even split or slight negative split', 'Random pace changes', 'Stop mid‑race and rest'],
        'correctIndex': 1,
        'points': 2,
      },
      {
        'type': 'identification',
        'text': 'Term for faster second half than first.',
        'answer': 'Negative split',
        'altAnswers': ['negative split','negativesplit','negative‑split'],
        'points': 3,
      },
      {
        'type': 'true_false',
        'text': 'Technique efficiency reduces energy cost per cycle.',
        'answer': true,
        'points': 0,
      },
      {
        'type': 'multiple_choice',
        'text': 'Which metrics pair best to manage effort?',
        'options': ['Score only', 'Heart rate and cadence', 'Jump height', 'Throw accuracy'],
        'correctIndex': 1,
        'points': 2,
      },
    ];
